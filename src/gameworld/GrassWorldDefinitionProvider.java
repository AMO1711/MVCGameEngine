...
public class GrassWorldDefinitionProvider extends AbstractWorldDefinitionProvider {

    public GrassWorldDefinitionProvider(DoubleVector worldDimension, ProjectAssets assets) {
